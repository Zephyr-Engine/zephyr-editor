...
pub const Textures = struct {
    ...
    pub fn init(renderer: *ui.OpenGlRenderer, allocator: std.mem.Allocator) !Textures {
        ...
        textures.play = try load(renderer, allocator, "play.png", @embedFile("resources/assets/play.png"));
        textures.pause = try load(renderer, allocator, "pause.png", @embedFile("resources/assets/pause.png"));
        textures.stop = try load(renderer, allocator, "stop.png", @embedFile("resources/assets/stop.png"));
        return textures;
    }

    pub fn deinit(self: *Textures, renderer: *ui.OpenGlRenderer) void {
